<template>
  <v-container fluid grid-list-sm>
    <v-row justify="center">
      <add-brand @refresh="getBrands()" v-if="add" />
      <edit-brand :item="singleItem" @refresh="getBrands()" v-if="edit" />
            ...
            <div class="datatable">
              ...
              >
                <template v-slot:item.actions="{ item }">
                  <v-icon @click="editBrand(item)">
                    mdi-square-edit-outline
                  </v-icon>
                  <v-icon @click="deleteBrand(item)">
...
export default {
  ...
  middleware({ $gates, redirect }) {
      if (!$gates.hasPermission("brand.view")) {
  ...
  components: {
    addBrand: () => import("@/components/product/addBrand"),
    editBrand: () => import("@/components/product/editBrand")
  },
  data() {
    return {
      add: false,
